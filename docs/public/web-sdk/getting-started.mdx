...
<div
  ...
  style={{
    ...
    lineHeight: 1.25,
    padding: "16px",
    border: "solid 2px #ffca2b",
  }}
>
  **EDITOR NOTE:** Do not update this guide directly in Mintlify. Please make
  changes in the [web-sdk](https://github.com/payrails/web-sdk) repository instead.
</div>

![](/images/web-sdk/pr.jpg)


Hello, this changed from web-sdk!
